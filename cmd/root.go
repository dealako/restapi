...
func create(cmd *cobra.Command, args []string) {
	...
	statsClient, err := statsd.New(statsd.Address(fmt.Sprintf("%s:%d", statsHost, statsPort))) // Connect to the UDP host:port
	if err != nil {
...
func getBooks(w http.ResponseWriter, r *http.Request) {
	// Increment our stats
	statsClient.Increment("restapi.book.get.counter")
...
func getBook(w http.ResponseWriter, r *http.Request) {
	// Increment our stats
	statsClient.Increment("restapi.book.getId.counter")
...
func createBook(w http.ResponseWriter, r *http.Request) {
	// Increment our stats
	statsClient.Increment("restapi.book.create.counter")
...
func updateBook(w http.ResponseWriter, r *http.Request) {
	// Increment our stats
	statsClient.Increment("restapi.book.update.counter")
...
func deleteBook(w http.ResponseWriter, r *http.Request) {
	// Increment our stats
	statsClient.Increment("restapi.book.delete.counter")
